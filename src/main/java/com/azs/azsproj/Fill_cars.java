...
class Fill_cars extends Price {
    ...
    @FXML
    public TextField Field_reg_Liters_cart;
    @FXML
    ...
    public void Field_sum() {
        double price = Double.parseDouble(fil_price.getText());
        double liters = Double.parseDouble(Field_sum.getText());
    ...
    public void Field_Liters_oil(){
        double price = Double.parseDouble(fil_price.getText());
        double liters = Double.parseDouble(Field_Liters_oil.getText());
    ...
    public void preview() throws SQLException {
        ...
        double cartLiters = Double.parseDouble(Field_Liters_oil.getText());
        double cartPrice = Double.parseDouble(fil_price.getText());
        double cartSumm = Double.parseDouble(Field_sum.getText());
